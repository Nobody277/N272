...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const isTransition = urlParams.get('transition') === 'true';
  
    createStars();
    setInterval(createShootingStar, 2000);
    animateEntrance(isTransition);
    initializeChart();
   ...
   * @param {boolean} isTransition - True if coming from a transition.
   */
  function animateEntrance(isTransition) {
